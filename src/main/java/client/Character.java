...
public class Character extends AbstractCharacterObject {
    ...
    public void sendPolice(int greason, String reason, int duration) {
        sendPacket(PacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for %s.#k", "NovaMS", reason)));
        this.isbanned = true;
    ...
    public void autoban(String reason) {
        ...
        this.ban(reason);
        sendPacket(PacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for HACK reason.#k", "NovaMS")));
        TimerManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                client.disconnect(false, false);
